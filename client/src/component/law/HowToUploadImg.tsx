    ...
    return (
        <div className="how-to-connect-box">
            <div className="container">
                ...
                <p>OCR에 등록할 이미지 올리기 전 정확도를 높일 수 있는 이미지 규격 가이드 안내입니다. <br />보다 더 높은 매칭률로 분리수거 방법을 추천 받아보세요!</p>
                <hr />

                <h3>1단계: 이미지 캡쳐는 최대한 상품명 기준으로 영역잡기</h3>

                <ol>
                    <li>
                        매칭에 필요하지 않은 부가 정보는 제외하고, <strong>'상품명'</strong>기준으로 캡쳐해주세요.<br />
